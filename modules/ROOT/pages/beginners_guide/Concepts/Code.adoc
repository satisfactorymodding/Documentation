...
+
BluePrints::
  We will discuss this in this xref:beginners_guide/Concepts/BluePrints.adoc[Concept-Page]
...
xref:beginners_guide/Concepts/BluePrints.adoc[Concept-Page] about that topic.
====
