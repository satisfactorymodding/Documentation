...
built rail pieces
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote11.png[]
...
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote13.png[]
...
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote15.png[]

Step 2: Add 2 more foundations to the first spoke above the ground level, and a rail starting from
3/4ths of the incline:
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote16.png[]

Step 3: Bring the initial entry point of the Rail to just about halfway before the first spoke:
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote17.png[]

Step 4: Connect the two rails with a curve.
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote18.png[]
...
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote26.png[]
A Block Segment that is currently occupied. The Red Signal will prevent another train from entering.

image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote27.png[]
...
image:modules/ROOT/images/LynkfoxTrainSignalGuide/TrainNote28.png[]
