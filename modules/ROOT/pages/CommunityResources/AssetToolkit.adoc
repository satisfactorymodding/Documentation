...
Download a zip of the repository and extract it somewhere, or clone it if desired.

=== Installing the Asset Generator

Place **both** the `AssetGenerator` **and** `AssetDumper` folders from the repo in your modding project's `Plugins` folder.
