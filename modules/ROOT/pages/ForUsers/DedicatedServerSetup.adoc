...
4. Enter server connection details in the popup window.
  a. link:#FileTransferMethods[File Transfer Methods] section has more information regarding FTP/SFTP configurations.
...
4. Enter server connection details in the popup window.
  a. If the server is not hosted locally to ficsit-cli, enter the server connection details. 
   - link:#FileTransferMethods[File Transfer Methods] section has more information regarding FTP/SFTP/SMB configurations.
