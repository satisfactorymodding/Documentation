...
4. If the server is not hosted locally to ficsit-cli, enter the server connection details. 
  Refer to link:#FileTransferProtocols[File Transfer Protocols section] for more details. 
  Otherwise, use the file system path necessary. Ex D:\SatisfactoryDS or /opt/SatisfactoryDedicatedServer
...
[id="FileTransferProtocols"]
=== FTP - File Transfer Protocol

File transfer protocol (FTP) is a common, but outdated method to transfer files over the Internet/Network. 
The commonly used port number is TCP/21, however, refer to your provider for any specific configuration setups. 
The examples provided are for a self-hosted dedicated server.

The username used requires Read/Write/Delete or Read/Modify permissions. Refer to your provider for any issues 
accessing the Dedicated Server location.

The path required for FTP to be used is the following: Refer to the examples for more information.
...
The commonly used port number is TCP/22, however, refer to your provider for any specific configuration setups. 
The examples provided are for a self-hosted dedicated server.

The username used requires Read/Write/Delete or Read/Modify permissions. Refer to your provider for any issues accessing the Dedicated Server location.
...
=== SMB/CIFS - Server Message Block/Common Internet File System _(i.e. Windows Network Share)_ *CURRENTLY FICSIT-CLI ONLY*
...
The commonly used port number is TCP/445, however, refer to your provider for any specific configuration setups. 
The examples provided are for a self-hosted dedicated server.
