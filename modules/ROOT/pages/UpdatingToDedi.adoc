...
This is a condensed guide for Dedicated Server Support, these instructions, either in exact or similiar form, are present in the normal setup documentation. 
