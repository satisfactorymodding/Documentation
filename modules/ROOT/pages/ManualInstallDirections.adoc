...
If you're a mod developer, you should still strongly consider using the launcher. You can use `For Mod Developers > Toggle SML always installed` to handle installing SML and the bootstrapper for you.
