...
designed to allow adding extra functionality or components to existing Unreal Actors your mod doesn't own.
...
Actor Mixins replaced the previous xref:Development/ModLoader/SimpleConstructionScript.adoc[SCS Hooks] system in SML 3.11.
