...
link:https://en.cppreference.com/cpp/language/friend[Click to learn more about the {cpp} friend declaration].
...
Creates the public methods `FORCEINLINE PropertyType GetmSomeProperty() { return mSomeProperty; }` and `FORCEINLINE void SetmSomeProperty(PropertyType SomeProperty) { mSomeProperty = SomeProperty; }` on `AFGSomeClass`.
...
[source,ini]
----
Accessor=(Class="AFGEquipment", Property="mCostToUse")
----
...
[source,ini]
----
BlueprintCallable=(Class="/Script/FactoryGame.FGSomeClass", Function="FunctionName")
----
...
[source,ini]
----
EditAnywhere=(Class="/Script/FactoryGame.FGSomeClass", Property="mSomeProperty")
----
...
[source,ini]
----
BlueprintType=(Struct="/Script/FactoryGame.FGSomeStruct")
----
