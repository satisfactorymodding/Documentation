...
you will have to find the parent {cpp} class that owns that property and use it in the access transfomer.
...
----
[AccessTransformers]
BlueprintReadWrite=(Class="AFGFoundationHologram", Property="mMaxZoopAmount")
----
