...
**Suggested Module Name: `InitInstance_YourModReferenceHere`**
...
**Suggested Module Name: `InitMenu_YourModReferenceHere`**
...
**Suggested Module Name: `InitGame_YourModReferenceHere`**
