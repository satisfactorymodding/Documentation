...
Variable Power::
  ...
  As of Update 5, the Particle Accelerator is the only base-game building that supports this feature.
  {blank} +
...
M Description::
  ...
  As of Update 5, only AWESOME Shop schematics actually display this field anywhere in-game.
  {blank} +
