...
In the xref:Development/BeginnersGuide/StarterProjectStructure.adoc[next section],
a brief overview of the files included in the Starter Project will help you get situated in the project
before working on your first mod.
