...
Then use the "Major" and "Version" dropdowns to select the same version you installed earlier (likely `2023.1.14.8770`). 
// Not applicable for 2023.1.14.8770, but leaving this note here in case the version number changes in the future.
...
If version `2023.1.14.8770` does not appear even after you have selected `All`,
...
The correct engine version should appear in the picker as `5.6.1-CSS` and should not be considered a binary build.
