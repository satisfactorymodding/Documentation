...
Then select the same version you installed earlier (likely `2021.1.0.7575`). 
...
If this version still doesn't show up, try any other version starting with `2021.1`.
