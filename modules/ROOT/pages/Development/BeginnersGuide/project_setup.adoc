...
To develop for 3.6.1, use this zip:
https://github.com/satisfactorymodding/SatisfactoryModLoader/archive/refs/tags/v3.6.1.zip
====
...
// dedi-docs must switch out this section once dedi is ready
=== Packaging Mods with Alpakit

In order to package a mod, press the "Alpakit!" button next to it in the list.

Alternatively, you can package multiple mods at once by marking the checkboxes and using "Alpakit Selected".
If you selected a Launch Game After Packing option it will wait for all tasks to complete before launching.

A popup will appear informing you that the mod is being packaged
