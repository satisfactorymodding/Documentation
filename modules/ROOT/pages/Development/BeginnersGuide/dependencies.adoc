...
NOTE: This is for setting up the Modding Environment on Windows. If you are on Linux, please follow the guide xref:Development/BeginnersGuide/LinuxSetup.adoc[here].
