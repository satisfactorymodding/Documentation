...
You'll need to register your GitHub account with Epic Games and join the [Epic Games GitHub organization](https://github.com/epicgames) to be able to download this special version. Directions on how to do so can be found https://www.unrealengine.com/en-US/ue4-on-github[here].
