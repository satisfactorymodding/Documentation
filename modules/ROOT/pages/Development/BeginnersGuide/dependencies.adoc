...
====
This is the *archived 3.7.0* version of the docs.
...
To develop for 3.7.0, use this engine version:
https://github.com/satisfactorymodding/UnrealEngine/releases/tag/5.2.1-css-60
====
...
To develop for 3.7.0, use this zip:
https://github.com/satisfactorymodding/SatisfactoryModLoader/archive/refs/tags/v3.7.0.zip
====
