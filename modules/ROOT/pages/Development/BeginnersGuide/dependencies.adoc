...
We suggest either Visual Studio 2019 or 2017 Community, because they're free of charge. It is important that if you use 2019 you still install the https://visualstudio.microsoft.com/vs/older-downloads/[2017 compilers]. It may force you to sign up to access the older versions, but they are free.
...
[TIP]
====
You will find the 2017 compilers under the Individual Components when you modify the installation of later versions.
