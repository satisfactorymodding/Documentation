...
Cross-compiling from Windows to Linux requires the compatible version of Unreal Engine specific CLang Toolchain installed prior to building for Linux_Shipping_Server. This can be found here: https://docs.unrealengine.com/4.26/en-US/SharingAndReleasing/Linux/GettingStarted/[Cross-Compiling for Linux]
