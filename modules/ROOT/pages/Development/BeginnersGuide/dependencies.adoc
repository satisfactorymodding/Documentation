...
To develop for 3.5.1, use this engine version:
https://github.com/satisfactorymodding/UnrealEngine/releases/tag/5.1.1-css-57
====
...
To develop for 3.5.1, clone the `v3.5.1` tag of the repo.
====
