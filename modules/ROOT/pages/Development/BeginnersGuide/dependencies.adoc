...
To develop for 3.4.1, use this version:
https://github.com/SatisfactoryModdingUE/UnrealEngine/releases/tag/4.26.2-css-40
====
...
To develop for 3.4.1, use this zip:
https://github.com/satisfactorymodding/SatisfactoryModLoader/archive/refs/tags/v3.4.1.zip
====
