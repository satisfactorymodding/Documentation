...
This side bar can be thought of as a folder system.
...
Your Unreal plugin will need to use the mod reference as its name,
...
Next us is setting up your modding development environment.
