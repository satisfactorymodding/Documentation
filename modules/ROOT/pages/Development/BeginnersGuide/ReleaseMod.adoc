...
Using 'Alpakit Selected!' or the 'Alpakit!' (just this mod) buttons generate a zip archive for you located at
// dedi-docs
// Using 'Alpakit Dev' or the 'Alpakit!' (just this mod) buttons generate a zip archive for you located at
`<starter project folder>/Saved/ArchivedPlugins/Windows/YourModReference/YourModReference-Windows.zip`.
...
////
dedi-docs
Make sure that you have the Release Targets configured correctly for your mod,
you most likely want all three (Windows, WindowsServer, and LinuxServer) checked.
...
This time you'll want to use the 'Alpakit Release' button.

Using 'Alpakit Release' will generate a different zip for you in the same folder called `YourModReference.zip`
that contains all of the selected targets in one file ready to be uploaded to SMR.
////
