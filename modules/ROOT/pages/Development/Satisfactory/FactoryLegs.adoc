...
* Named leg sockets defined on your building's mesh
    ** The https://dev.epicgames.com/documentation/unreal-engine/using-sockets-with-static-meshes-in-unreal-engine?application_version=5.6[Unreal documentation]
