...
[NOTE]
====
Ben (CSS employee) has confirmed that this system will be changing in a future update, and that these steps will soon change, or may no longer be required. Consider waiting to set up these conveyor materials until the new system is released.
====
