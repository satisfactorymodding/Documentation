...
xref:Development/ModLoader/ActorMixins.adoc[Actor Mixins] to attach a component to the player's PlayerState.
Check out the Example Mod's `ExampleModPlayerDataComponent` for an example of how to do this.
