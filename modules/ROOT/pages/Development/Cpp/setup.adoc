...
https://dev.epicgames.com/documentation/en-us/unreal-engine/epic-cplusplus-coding-standard-for-unreal-engine?application_version=5.3#namingconventions[Coding Standard for Unreal Engine] documentation page.
