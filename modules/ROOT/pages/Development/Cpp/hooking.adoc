...
All C/C++ functioning hooking stuff can be found in `#include <mod/hooks.h>`.
All Blueprint function hook stuff can be found in `#include <mod/blueprint_hooking.h>`.
