...
== Understanding Blueprint vs {cpp}
...
Learn what makes {cpp} and Blueprints different, what they have in common, and how to use them together effectively.
====
...
We have compiled a list of some helpful
xref:Development/UnrealEngine/UnrealLearningResources.adoc[Unreal Learning Resources],
but you will probably want to search out some more on your own.
Let us know which ones you found helpful so we can add them to the list!
...
* External resources linked on the xref:Development/UnrealEngine/UnrealLearningResources.adoc[Unreal Learning Resources page]
...
In order to effectively write {cpp} mods, you will require both general {cpp} knowledge, and knowledge about how {cpp} applies to Unreal Engine systems.
Unreal's documentation covers this in its
