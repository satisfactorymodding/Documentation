...
- Implement functionality in Blueprints,
...
As described in the 'Keep an Old Version On Hand' section,
...
Depending on how you obtained your modding files,
...
Editor are stored at the project level, and if you have any special ones,
...
=== Option Two: Replace Changed Files

If you have a lot of plugins set up in modding project,
...
==== 2A: You Cloned or Forked the Starter Project
...
- `/Configs/` folder contents (see the 'Bring Over Editor Configs' section)
- `/Content/` folder contents (see the 'Dealing With the Content Folder'
  and 'Watch Out: Complete Starter Projects and Version Control' sections)
...
==== 2B: You Downloaded a Zip of the Starter Project
...
==== 2C: You Have a Project Level Repo
...
You'll probably want to throw out all the old asset files generate a fresh complete content folder.
