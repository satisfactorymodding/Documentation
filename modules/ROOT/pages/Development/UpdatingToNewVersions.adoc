...
[IMPORTANT]
====
If you are updating from SML3.4 to SML3.5, make sure to check out the
xref:Development/UpdatingFromSml34.adoc[dedicated Updating from SML 3.4.1 guide page] first.
====
