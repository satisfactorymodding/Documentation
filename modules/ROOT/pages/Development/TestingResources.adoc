...
Similar arugments also exist for the console window (`ConsoleX` and `ConsoleY`).
You can also specifiy what resolution you want the game to run at: `-WinX=1280 -WinY=720`.

If you want windows to open on other monitors, you will need to use either negative or larger numbers for the arguments.
