...
Coffee Stain and Fishlabs have made some engine and engine plugin modifications
in furtherance their work maintaining console support.
...
https://github.com/satisfactorymodding/SatisfactoryModLoader/compare/v3.12.0...v3.11.0
