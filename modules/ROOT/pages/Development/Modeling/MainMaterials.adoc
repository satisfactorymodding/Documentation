...
For full information on how to setup the material to perform as a Conveyor item please reference the xref::/Development/Satisfactory/ConveyorRendering.adoc[Conveyor Rendering] page.
