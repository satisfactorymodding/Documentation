...
https://dev.epicgames.com/documentation/unreal-engine/text-localization-in-unreal-engine?application_version=5.6[Unreal documentation].
...
If your mod depends on localized content from other mods,
select that mod's target(s) in the "Target Dependencies" to avoid it being gathered by both mods.

image:L10n/ConfigureTargetDependencies.png[Configuring target dependencies]
