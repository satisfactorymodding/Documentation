...
=== Bitmask BitmaskEnum Increased Specificity
...
This error is caused by Unreal increasing the specificity of the `BitmaskEnum` UPARAM meta specifier.

If your code was originally this:
...
You can fix it by changing the BitmaskEnum to what the error message mentioned, like this:
