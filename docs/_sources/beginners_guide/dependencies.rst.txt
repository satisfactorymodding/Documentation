...
Again, just go into the Epic Games Lancher and then select the Unreal Engine tab at the left hand side of the launcher.
...
.. warning:: Unreal Engine 4 is quite big, espetialliy if you want to install the source and the debug code. You should be realy sure were you want to install Unreal.
